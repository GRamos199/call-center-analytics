...
def generate_weekly_overall(start_date: str = "2025-01-06", num_weeks: int = 52) -> pd.DataFrame:
...
def generate_weekly_agent(start_date: str = "2025-01-06", num_weeks: int = 52) -> pd.DataFrame:
    ...
    for week in weeks:
        for agent in AGENTS:
            ...
            total_handled = calls_handled + emails_handled + chats_handled + whatsapp_handled
...
def generate_weekly_channel(start_date: str = "2025-01-06", num_weeks: int = 52) -> pd.DataFrame:
    """Generate weekly channel metrics."""
    weeks = get_mondays(start_date, num_weeks)
    
    channel_config = {
        "Phone": {"volume_range": (800, 1200), "handle_time": (12, 18), "cost_key": "cost_per_call"},
        "Email": {"volume_range": (300, 500), "handle_time": (8, 15), "cost_key": "cost_per_email"},
        "Chat": {"volume_range": (400, 600), "handle_time": (6, 12), "cost_key": "cost_per_chat"},
        "WhatsApp": {"volume_range": (200, 400), "handle_time": (5, 10), "cost_key": "cost_per_whatsapp"},
    }
...
def generate_weekly_calls(start_date: str = "2025-01-06", num_weeks: int = 52) -> pd.DataFrame:
    ...
    for week in weeks:
        ...
        for day_offset in range(7):
            ...
            for _ in range(num_calls):
                ...
                satisfaction = np.random.randint(1, 6) if resolved else np.random.randint(1, 4)
...
def generate_monthly_overall(start_date: str = "2025-01-01", num_months: int = 12) -> pd.DataFrame:
...
def generate_monthly_agent(start_date: str = "2025-01-01", num_months: int = 12) -> pd.DataFrame:
...
def generate_monthly_channel(start_date: str = "2025-01-01", num_months: int = 12) -> pd.DataFrame:
    """Generate monthly channel metrics."""
    months = get_months(start_date, num_months)
    
    channel_config = {
        "Phone": {"volume_range": (3500, 5000), "handle_time": (12, 18), "cost_key": "cost_per_call"},
        "Email": {"volume_range": (1200, 2000), "handle_time": (8, 15), "cost_key": "cost_per_email"},
        "Chat": {"volume_range": (1600, 2400), "handle_time": (6, 12), "cost_key": "cost_per_chat"},
        "WhatsApp": {"volume_range": (800, 1600), "handle_time": (5, 10), "cost_key": "cost_per_whatsapp"},
    }
...
def generate_monthly_calls(start_date: str = "2025-01-01", num_months: int = 12) -> pd.DataFrame:

...
class MetricLoader:
    ...
    def get_agent_metrics(self, period_date: Optional[datetime] = None, agent_id: Optional[int] = None) -> pd.DataFrame:
        """
    ...
    def get_channel_metrics(self, period_date: Optional[datetime] = None, channel: Optional[str] = None) -> pd.DataFrame:
        """
    ...
    def calculate_productivity_metrics(self, period_date: Optional[datetime] = None) -> Dict:
        """
        ...
        interactions_per_agent = overall.get("total_interactions", 0) / unique_agents if unique_agents > 0 else 0
        ...
        return {
            ...
            "customer_satisfaction_score": overall.get("customer_satisfaction_score", 0),
    ...
    def calculate_cost_per_agent(self, period_date: Optional[datetime] = None) -> pd.DataFrame:
        """
        ...
        if agent_df.empty:
            return pd.DataFrame(columns=[
                "agent_id", "agent_name", "department", "total_interactions",
                "hours_worked", "total_cost", "cost_per_interaction"
            ])
    ...
    def calculate_channel_performance(self, period_date: Optional[datetime] = None) -> pd.DataFrame:
        """
    ...
    def get_agent_trend_data(self, agent_id: int, metric_name: str, num_periods: int = 12) -> pd.DataFrame:
        """
    ...
    def get_daily_breakdown(self, period_date: Optional[datetime] = None) -> pd.DataFrame:
        """
        ...
        daily.columns = [
            "date", "total_calls", "total_duration", "avg_duration",
            "agents_active", "calls_resolved", "avg_satisfaction"
        ]
    ...
    def get_hourly_distribution(self, period_date: Optional[datetime] = None) -> pd.DataFrame:
        """
        ...
        hourly = calls_df.groupby("hour").agg({
            "call_id": "count",
